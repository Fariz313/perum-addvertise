<template>
  <div>
    ...
    <header class="masthead">
      <div class="container">
        <div class="masthead-subheading colprim">Welcome !</div>
        <div class="masthead-heading text-uppercase">CASA LAVENIA</div>
        <a
          href="https://chatwith.io/s/60652a0fe1052"
          style="
            display: table;
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="portfolio-item">
              ...
              <div class="portfolio-caption">
                <div class="portfolio-caption-heading">Gambar</div>
